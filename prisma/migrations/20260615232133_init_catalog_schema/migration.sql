...
-- CreateEnum
CREATE TYPE "CurrencyCode" AS ENUM ('ARS');
...
-- CreateIndex
CREATE INDEX "Product_brandId_status_isActive_idx" ON "Product"("brandId", "status", "isActive");

-- CreateIndex
CREATE INDEX "Product_featured_status_isActive_idx" ON "Product"("featured", "status", "isActive");
