...
export type SafeError<A extends NextAction = NextAction> = { code: SafeCode; nextAction: A; message: string };
...
export type ProviderOrderEvidence = { id: string; externalReference?: string; status: string; statusDetail: string; updatedAt: string; payment: ProviderPaymentEvidence };
